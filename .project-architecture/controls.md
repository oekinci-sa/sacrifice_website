...
| Sıra ekranları | `/kesimsirasi`, `/parcalamasirasi`, `/teslimatsirasi` | Min 1, max kurban no; PIN set ise 6 haneli gate; kurban no / hissedar arama; switch altında hissedar tablosu (light) |
