-- ===============================================
-- Açıklama: reservation_transactions tablosundaki last_edited_time alanını
...
CREATE OR REPLACE FUNCTION update_last_edited_time()
RETURNS TRIGGER AS $$
BEGIN
...
FOR EACH ROW
EXECUTE FUNCTION update_last_edited_time();
