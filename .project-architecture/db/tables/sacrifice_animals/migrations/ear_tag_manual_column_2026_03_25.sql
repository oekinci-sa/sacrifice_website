ALTER TABLE public.sacrifice_animals ADD COLUMN IF NOT EXISTS ear_tag text;
...
ALTER TABLE public.sacrifice_animals DROP COLUMN IF EXISTS ear_tag_override;
ALTER TABLE public.sacrifice_animals DROP COLUMN IF EXISTS ear_tag_display;
