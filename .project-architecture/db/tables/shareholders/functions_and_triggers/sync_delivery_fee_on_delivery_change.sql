-- ===============================================
-- delivery_location veya delivery_type değiştiğinde delivery_fee, total_amount,
-- remaining_payment otomatik güncelle. Hem Ankara Kurban hem Elya için.
-- Trigger: sync_delivery_fee (BEFORE UPDATE)
--
-- ÖNEMLİ: Teslimat ücreti mantığı değişirse lib/delivery-options.ts ile senkron
-- tutulmalı (getDeliveryFeeForType, getDeliveryFeeForLocation).
-- ===============================================
...
BEGIN
  ...
  -- delivery_location veya delivery_type değişmediyse mevcut trigger'a bırak
