...
export default function UyumsuzHisselerPage() {
  ...
  const columns = useMemo(
    () => createColumns(handleAcknowledge, acknowledgingId),
    [handleAcknowledge, acknowledgingId]
  );
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Hissedar sayısı ile boş hisse toplamı 7 olmayan kurbanlıkları
            listeler.
          </p>
        </div>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Hissedar sayısı ile boş hisse toplamı 7 olmayan kurbanlıkları
          listeler. Yeni hissedar eklendiğinde farkındalık sıfırlanır.
        </p>
      </div>
