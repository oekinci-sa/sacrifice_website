...
export function ShareholderDetails({ shareholderInfo }: ShareholderDetailsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-6 space-x-12 w-full p-4 md:p-12 border border-gray-200 rounded-lg">
      ...
      <div className="col-span-1 md:col-span-5 space-y-8 md:space-y-12">
        ...
        <div className="space-y-4">
          <h3 className="text-lg md:text-xl font-semibold">Kurbanlık Bilgileri</h3>
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-xs md:text-sm text-slate-600 font-medium mb-1">Kilogram</p>
                <p className="font-medium text-sm md:text-lg">26 ±3</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex flex-row justify-between items-start md:items-center gap-4 md:gap-0">
            <h3 className="text-lg md:text-xl font-semibold">Ödeme Detayları</h3>
            <Button
              className="w-auto bg-[#f8f8f8] text-black hover:bg-[#e8e8e8] hover:text-black border-[#39C645]"
          ...
          <div className="flex justify-between items-start gap-4">
            <div className="space-y-1">
              <p className="text-xs md:text-sm text-muted-foreground">Son kapora ödeme tarihi</p>
            ...
            <div className="text-right space-y-1">
              <p className="text-xs md:text-sm text-muted-foreground">Toplam Ücret</p>
