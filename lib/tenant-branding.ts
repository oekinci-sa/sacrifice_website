...
export async function getTenantBranding(): Promise<TenantBranding> {
  ...
  return {
    ...
    homepage_mode: (data.homepage_mode as HomepageMode | null) ?? "bana_haber_ver",
  };
}
